...
export const BENCHMARK_SEEDS: BenchmarkRow[] = [
  ...
  // Urology
  ...MAKE("urology", [
    ["revenuePerProvider", 98000, 78000, 120000, 58000, 1, "usd"],
    ["daysInAR", 39, 31, 47, 58, 0, "days"],
    ["netCollectionRate", 96.0, 93.4, 97.8, 90, 1, "percent"],
    ["contractualAdjustmentRate", 32, 26, 38, 46, 0, "percent"],
    ["insuranceMixCommercial", 60, 48, 72, 35, 1, "percent"],
    ["avgReimbursementRate", 71, 63, 79, 55, 1, "percent"],
    ["thirdNextAvailable", 12, 7, 18, 27, 0, "days"],
    ["noShowRate", 7.8, 5.0, 10.5, 15, 0, "percent"],
    ["schedulingEfficiency", 80, 72, 88, 64, 1, "percent"],
    ["staffToProviderRatio", 3.3, 2.7, 3.9, 4.7, 0, "ratio"],
    ["providerTurnoverRate", 7, 4, 11, 17, 0, "percent"],
    ["staffTrainingInvestment", 1.9, 1.1, 2.7, 0.5, 1, "percent"],
    ["operatingExpenseRatio", 64, 58, 70, 76, 0, "percent"],
    ["costPerPatientVisit", 230, 190, 280, 330, 0, "usd"],
    ["patientSatisfactionScore", 4.5, 4.2, 4.7, 4.0, 1, "score"],
    ["qualityComplianceRate", 92, 87, 96, 80, 1, "percent"],
  ]),

  // Plastic Surgery
  ...MAKE("plastic_surgery", [
    ["revenuePerProvider", 135000, 100000, 175000, 65000, 1, "usd"],
    ["daysInAR", 30, 22, 40, 52, 0, "days"],
    ["netCollectionRate", 96.5, 94.0, 98.2, 90, 1, "percent"],
    ["contractualAdjustmentRate", 22, 15, 30, 40, 0, "percent"],
    ["insuranceMixCommercial", 45, 30, 62, 20, 1, "percent"],
    ["avgReimbursementRate", 76, 66, 86, 58, 1, "percent"],
    ["thirdNextAvailable", 10, 5, 16, 24, 0, "days"],
    ["noShowRate", 8.5, 5.5, 11.5, 16, 0, "percent"],
    ["schedulingEfficiency", 81, 73, 89, 65, 1, "percent"],
    ["staffToProviderRatio", 3.8, 3.0, 4.6, 5.4, 0, "ratio"],
    ["providerTurnoverRate", 9, 5, 14, 20, 0, "percent"],
    ["staffTrainingInvestment", 2.2, 1.4, 3.0, 0.6, 1, "percent"],
    ["operatingExpenseRatio", 63, 56, 70, 76, 0, "percent"],
    ["costPerPatientVisit", 280, 220, 350, 420, 0, "usd"],
    ["patientSatisfactionScore", 4.6, 4.3, 4.8, 4.1, 1, "score"],
    ["qualityComplianceRate", 91, 86, 95, 79, 1, "percent"],
  ]),

  // Radiology
  ...MAKE("radiology", [
    ["revenuePerProvider", 150000, 115000, 190000, 80000, 1, "usd"],
    ["daysInAR", 41, 33, 50, 62, 0, "days"],
    ["netCollectionRate", 95.8, 93.0, 97.6, 89, 1, "percent"],
    ["contractualAdjustmentRate", 34, 28, 40, 48, 0, "percent"],
    ["insuranceMixCommercial", 58, 45, 70, 32, 1, "percent"],
    ["avgReimbursementRate", 68, 60, 76, 52, 1, "percent"],
    ["thirdNextAvailable", 7, 3, 13, 20, 0, "days"],
    ["noShowRate", 6.0, 4.0, 8.5, 12, 0, "percent"],
    ["schedulingEfficiency", 84, 76, 91, 68, 1, "percent"],
    ["staffToProviderRatio", 2.8, 2.2, 3.4, 4.2, 0, "ratio"],
    ["providerTurnoverRate", 6, 3, 10, 15, 0, "percent"],
    ["staffTrainingInvestment", 2.0, 1.2, 2.8, 0.6, 1, "percent"],
    ["operatingExpenseRatio", 60, 54, 66, 73, 0, "percent"],
    ["costPerPatientVisit", 200, 165, 250, 300, 0, "usd"],
    ["patientSatisfactionScore", 4.4, 4.1, 4.6, 3.9, 1, "score"],
    ["qualityComplianceRate", 93, 88, 96, 81, 1, "percent"],
  ]),

  // Cardiology
  ...MAKE("cardiology", [
    ["revenuePerProvider", 125000, 95000, 158000, 70000, 1, "usd"],
    ["daysInAR", 40, 32, 48, 60, 0, "days"],
    ["netCollectionRate", 96.2, 93.6, 98.0, 90, 1, "percent"],
    ["contractualAdjustmentRate", 31, 25, 37, 45, 0, "percent"],
    ["insuranceMixCommercial", 56, 44, 68, 32, 1, "percent"],
    ["avgReimbursementRate", 72, 64, 80, 56, 1, "percent"],
    ["thirdNextAvailable", 11, 6, 17, 25, 0, "days"],
    ["noShowRate", 7.0, 4.5, 9.5, 14, 0, "percent"],
    ["schedulingEfficiency", 82, 74, 89, 66, 1, "percent"],
    ["staffToProviderRatio", 4.0, 3.3, 4.7, 5.6, 0, "ratio"],
    ["providerTurnoverRate", 7, 4, 11, 16, 0, "percent"],
    ["staffTrainingInvestment", 2.1, 1.3, 2.9, 0.6, 1, "percent"],
    ["operatingExpenseRatio", 66, 60, 72, 78, 0, "percent"],
    ["costPerPatientVisit", 260, 215, 320, 380, 0, "usd"],
    ["patientSatisfactionScore", 4.5, 4.2, 4.7, 4.0, 1, "score"],
    ["qualityComplianceRate", 93, 88, 96, 81, 1, "percent"],
  ]),

  // Pain Management
  ...MAKE("pain_management", [
    ["revenuePerProvider", 88000, 68000, 110000, 50000, 1, "usd"],
    ["daysInAR", 42, 34, 52, 64, 0, "days"],
    ["netCollectionRate", 95.4, 92.6, 97.4, 88, 1, "percent"],
    ["contractualAdjustmentRate", 35, 28, 42, 50, 0, "percent"],
    ["insuranceMixCommercial", 52, 40, 65, 28, 1, "percent"],
    ["avgReimbursementRate", 66, 58, 74, 50, 1, "percent"],
    ["thirdNextAvailable", 13, 7, 19, 28, 0, "days"],
    ["noShowRate", 9.5, 6.5, 12.5, 18, 0, "percent"],
    ["schedulingEfficiency", 78, 70, 86, 62, 1, "percent"],
    ["staffToProviderRatio", 3.5, 2.9, 4.1, 4.9, 0, "ratio"],
    ["providerTurnoverRate", 10, 6, 15, 21, 0, "percent"],
    ["staffTrainingInvestment", 1.7, 0.9, 2.5, 0.5, 1, "percent"],
    ["operatingExpenseRatio", 65, 59, 71, 77, 0, "percent"],
    ["costPerPatientVisit", 210, 175, 260, 310, 0, "usd"],
    ["patientSatisfactionScore", 4.4, 4.1, 4.6, 3.9, 1, "score"],
    ["qualityComplianceRate", 90, 85, 94, 78, 1, "percent"],
  ]),
];
